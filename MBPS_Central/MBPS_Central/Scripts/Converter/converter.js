...
DataConverter.prototype.create = function(w,h) {
  ...
  this.inputHeader = $('<div class="groupHeader" id="inputHeader"><p class="groupHeadline">Copy and Paste the Summary Tab details of your PT Excel. <span class="subhead"> Click <a href="#" data-toggle="modal" data-target="#myModal" id="learnMore">here</a> to learn more...</span></p></div>');
  this.inputTextArea = $('<textarea class="textInputs" id="dataInput"></textarea>');
  var outputHeaderText = '<div class="groupHeader" id="inputHeader" style="display:none;" ><p class="groupHeadline">Output as <select name="Data Types" id="dataSelector" >';
  ...
  this.outputTextArea = $('<textarea class="textInputs" id="dataOutput" style="display:none;"></textarea>');
...
DataConverter.prototype.convert = function() {
  ...
  if (this.inputText.length > 0) {
    ...
    this.outputText = DataGridRenderer['html'](dataGrid, headerNames, headerTypes, this.indent, this.newLine);
